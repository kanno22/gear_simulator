...
p [0:10] file u 1:2 axis x1y1 title "x[m]" w l lw 1, file u 1:3 axis x1y1 title "z[m]" w l lw 1; 

set terminal png
set output "/home/kanno/gear_simulator/simulator/log/images/high.png"
set title "High"
set ylabel "Position [m]"
p [0:10] file u 1:16 axis x1y1 title "zg[m]" w l lw 1, file u 1:3 axis x1y1 title "z[m]" w l lw 1; 

set terminal png
set output "/home/kanno/gear_simulator/simulator/log/images/wheelvelo.png"
set title "wheelvelo"
set ylabel "Velocity [m]"
p [0:10] file u 1:17 axis x1y1 title "wheel_velo[m/s]" w l lw 1, file u 1:18 axis x1y1 title "wheel_velo_ref[m/s]" w l lw 1; 
...
# set autoscale y2
p [0:10] file u 1:4 axis x1y1 title "angle 1[deg]" w l lw 1, file u 1:5 axis x1y1 title "angle m[deg]" w l lw 1, file u 1:6 axis x1y1 title "angle 2[deg]" w l lw 1, file u 1:7 axis x1y1 title "angle 3[deg]" w l lw 1; 

set terminal png
set output "/home/kanno/gear_simulator/simulator/log/images/Angle2_ref.png"
set title "Angle2_ref"
set ylabel "Angle [deg]"
p [0:10] file u 1:6 axis x1y1 title "moter angle[deg]" w l lw 1, file u 1:15 axis x1y1 title "moter angle ref[deg]" w l lw 1;
...
p [0:10] file u 1:6 axis x1y1 title "moter angle[deg]" w l lw 1, file u 1:14 axis x1y1 title "knee angle[deg]" w l lw 1, file u 1:5 axis x1y1 title "spring angle[deg]" w l lw 1, file u 1:11 axis x1y2 title "moter torque[N m]" w l lw 1, file u 1:13 axis x1y2 title "spring torque[N m]" w l lw 1; 
...
set ytics nomirror
set autoscale y2
p [0:10]  file u 1:11 axis x1y1 title "moter torque[N m]" w l lw 1, file u 1:13 axis x1y1 title "spring torque[N m]" w l lw 1,file u 1:8 axis x1y2 title "reaction force[N]" w l lw 1; 
